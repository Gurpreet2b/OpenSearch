...
@Component({
  selector: 'app-reportmail',
  templateUrl: './reportmail.component.html',
  styleUrls: ['./reportmail.component.css'],
})
export class ReportmailComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.fetchReportID = this.route.snapshot.paramMap.get('id');
    console.log("@@@@@@@@@@", this.fetchReportID);

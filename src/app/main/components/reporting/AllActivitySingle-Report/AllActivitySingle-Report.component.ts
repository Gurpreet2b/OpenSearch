...
export class AllActivitySingleReportComponent implements OnInit {
...
public FirewallActionChartData: any;
  ...
  //         this.acceptableApp_data = res.data.Data.IU.Productivity;
  //         this.acceptableAppTable_data = res.data.Data.IU.Productivity.ApplicationsTableData;
  //         this.acceptable_sites = res.data.Data.IU.Productivity;
  ...
  //         // this.productiveApp_data = res.data.Data.IU.Productive;
  ...
  //         this.unacceptableApp_data = res.data.Data.IU.Productivity.UnacceptableApplicationsByBrowsingTime;
  //         // this.unacceptableAppTable_data = res.data.Data.IU['Application-table'];
  //         this.unacceptableSites_data = res.data.Data.IU.Productivity.UnacceptableSitesByBrowsingTime;
  ...
  //         this.unproductiveApp_data = res.data.Data.IU.Productivity.UnproductiveApplicationsByBrowsingTime;
  //         // this.unproductiveAppTable_data = res.data.Data.IU['Application-table'];
  //         this.unproductiveSites_data = res.data.Data.IU.Productivity.UnproductiveSitesByBrowsingTime;
  ...
  //         this.categoriesSize_data = res.data.Data.IU.Bandwidth.CategoriesBySize;
  ...
  //         this.uiBlockedApplications_data = res.data.Data.IU.Blocked.Applications;
  //         this.uiBlockedCategories_data = res.data.Data.IU.Blocked.Categories;
  //         this.uiBlockedSites_data = res.data.Data.IU.Blocked.Sites;
  //         this.uiCategoriesBrowsingTime_data = res.data.Data.IU.Productivity.CategoriesByBrowsingTime;
  //         this.productiveAppBrowsing_data = res.data.Data.IU.Productivity.ProductiveApplicationsByBrowsingTime;
  //         this.productivitySites_data = res.data.Data.IU.Productivity.ProductiveSitesByBrowsingTime;
  ...
  public chartintialize(userType: string) {
    ...
    if (userType === 'singleuser') {
      ...
      this.setStackedBarChartBaseDataStructure('unacceptable-sites');
      this.AllowedUnacceptableSitesChartData['xAxis']['categories'] =
      ...
      this.setStackedBarChartBaseDataStructure('unproductive-applications');
      this.AllowedUnproductiveApplicationsChartData['xAxis']['categories'] =
        this.unproductiveApplications_data.AllowedUnproductiveApplications.Chart.Lables;
      ...
      this.setStackedBarChartBaseDataStructure('unacceptable-application');
      this.UnacceptableApplicationsChartData['xAxis']['categories'] =
        this.unacceptableApplication_data.AllowedUnacceptableApplications.Chart.Labels;
  ...
  reportingCharts() {
    ...
    // this.FirewallChartData = Highcharts.chart('FirewallChartData', this.FirewallActionsChartData);
    // this.FirewallActionChartData = Highcharts.chart('FirewallActionChartData', this.FirewallActionOvertimeChartData);
  }
